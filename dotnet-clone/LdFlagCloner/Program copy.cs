...
if (args.Length < 3)
{
    Console.WriteLine("Usage: LdFlagCloner <SourceProject> <DestinationProject> <FlagKeys>");
    Console.WriteLine("Example: LdFlagCloner my-source my-dest flag1:flag2:flag3");
    return;
}

string sourceProject = args[0];
string destinationProject = args[1];
string[] flagKeys = args[2].Split(':');
